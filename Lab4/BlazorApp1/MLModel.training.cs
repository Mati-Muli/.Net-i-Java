...
namespace BlazorApp1
{
    ...
    {
        public const string RetrainFilePath =  @"C:\Users\mmule\Downloads\.net ml\archive (1)\train.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"text",outputColumnName:@"text")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.LightGbm(new LightGbmMulticlassTrainer.Options(){NumberOfLeaves=1420,NumberOfIterations=245,MinimumExampleCountPerLeaf=20,LearningRate=0.9999997766729865,LabelColumnName=@"sentiment",FeatureColumnName=@"Features",Booster=new GradientBooster.Options(){SubsampleFraction=0.3031960973023559,FeatureFraction=0.9645201162132305,L1Regularization=2E-10,L2Regularization=0.3164929805673851},MaximumBinCountPerFeature=252}))      
